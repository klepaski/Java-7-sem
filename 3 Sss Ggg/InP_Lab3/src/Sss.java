    ...
    protected void service(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
        ...
        if (_click == null) {     // По гиперссылке
            ...
            if (_click.equalsIgnoreCase("value")) { // переадресация на Ggg
                resp.sendRedirect("http://172.16.193.69:8080/Chistyakova_3_lab_/Ggg");
            }
            ...
            if (_click.equalsIgnoreCase("value2")) {
                resp.sendRedirect("http://172.16.193.69:8080/Chistyakova_3_lab_/Ggg?param2=testvalue");
            ...
            if (_click.equalsIgnoreCase("value4")) {
                requestDispatcher = req.getRequestDispatcher("http://172.16.193.69:8080/Chistyakova_3_lab_/Ggg");
            ...
            if(_click.equalsIgnoreCase("value6")) {
                ...
                GetMethod gm = new GetMethod("http://172.16.193.69:8080/Chistyakova_3_lab_/Ggg?click=example&p1=Julia&p2=Chistyakova");
            ...
            if (_click.equalsIgnoreCase("value8")) {
                resp.sendRedirect("http://172.16.193.69:8080/Chistyakova_3_lab_/Ggg?param2=testvalue2");
            }

            if(_click.equalsIgnoreCase("value9")) {
                HttpClient hc2 = new HttpClient();
                PostMethod gm2 = new PostMethod("http://172.16.193.69:8080/Chistyakova_3_lab_/Ggg");
